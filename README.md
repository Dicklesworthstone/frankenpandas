...
| Medium | Shared thread pool | Replace per-call `thread::scope` fan-out (146 occurrences across 8 files) with one pool; the spawn cost is the dominant loss at 100k rows |
