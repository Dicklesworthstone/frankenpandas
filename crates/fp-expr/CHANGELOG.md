...
## [0.1.0](https://github.com/Dicklesworthstone/frankenpandas/releases/tag/fp-expr-v0.1.0) - 2026-06-07
...
- *(expr)* guard incremental fallback for stateful ops
- update tests for Float64 alignment promotion
...
- *(expr)* lock query operator parity (in/str/bitwise-precedence) vs pandas 2.2.3
- *(expr)* lock eval/query chained-comparison + floordiv/mod parity vs pandas 2.2.3
