...
## [0.1.0](https://github.com/Dicklesworthstone/frankenpandas/releases/tag/fp-runtime-v0.1.0) - 2026-06-08
...
- *(runtime)* harden conformal guard invariants (br-frankenpandas-lp4ae)
- *(fp-runtime)* bound recover_once retry loop at max_attempts even under buggy policy
- *(runtime)* replace placeholder raptorq envelope (frankenpandas-cod1m02)
...
- upgrade asupersync to 0.3.4 (0.3.3 was yanked)
- bump workspace deps (pyo3 0.23->0.28, mysql 26->28, asupersync 0.3.1->0.3.2, +patches)
...
- rustfmt reflows in proptest properties and asupersync recovery
