...
fn readme_categorical_analysis_compiles_and_runs() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Inferred categories are sorted, as pd.Categorical infers them:
    // excellent (idx 0), good (idx 1), poor (idx 2).
    assert_eq!(categories.len(), 3);
    assert_eq!(categories[0], Scalar::Utf8("excellent".into()));
    assert_eq!(categories[1], Scalar::Utf8("good".into()));
    assert_eq!(categories[2], Scalar::Utf8("poor".into()));

    // Codes: [1, 2, 0, 1] — last value is "good" again so reuses code 1.
    let codes = cat.codes()?;
    let code_values = codes.values();
    assert_eq!(code_values.len(), 4);
    assert_eq!(code_values[0], Scalar::Int64(1));
    assert_eq!(code_values[1], Scalar::Int64(2));
    assert_eq!(code_values[2], Scalar::Int64(0));
    assert_eq!(code_values[3], Scalar::Int64(1));
...
fn facade_io_surface_compile_guard() {
    ...
    let _ = (
        fp::read_clipboard,
        fp::read_clipboard_str,
        fp::read_csv,
        fp::read_csv_str,
        fp::read_csv_with_index_cols,
        fp::read_csv_with_index_cols_path,
        fp::read_csv_with_options,
        fp::read_csv_with_options_path,
        fp::read_excel,
        fp::read_excel_bytes,
        fp::read_excel_bytes_with_index_cols,
        fp::read_excel_sheets,
        fp::read_excel_sheets_bytes,
        fp::read_excel_sheets_ordered,
        fp::read_excel_sheets_ordered_bytes,
        fp::read_excel_with_index_cols,
        fp::read_feather,
        fp::read_feather_bytes,
        fp::read_fwf,
        fp::read_fwf_str,
        fp::read_gbq,
        fp::read_hdf,
        fp::read_hdf_key,
        fp::read_hdf_with_options,
        fp::read_html,
        fp::read_html_str,
        fp::read_html_str_with_options,
        fp::read_html_with_options,
        fp::read_ipc_stream_bytes,
        fp::read_json,
        fp::read_json_str,
        fp::read_jsonl,
        fp::read_jsonl_str,
        ...
        fp::read_orc_bytes,
        fp::read_parquet,
        fp::read_parquet_bytes,
        fp::read_pickle,
        fp::read_pickle_bytes,
        fp::read_pickle_bytes_with_options,
        fp::read_pickle_with_options,
        fp::read_sas,
        ...
        fp::read_table,
        fp::read_table_str,
        fp::read_table_with_options,
        fp::read_table_with_options_path,
        fp::read_xml,
        fp::read_xml_str,
        fp::read_xml_str_with_options,
        fp::read_xml_with_options,
        fp::write_csv,
        fp::write_csv_string,
        fp::write_csv_string_with_options,
        fp::write_excel,
        fp::write_excel_bytes,
        fp::write_excel_bytes_with_options,
        fp::write_excel_with_options,
        fp::write_feather,
        fp::write_feather_bytes,
        fp::write_hdf,
        fp::write_hdf_key,
        fp::write_hdf_series,
        fp::write_hdf_series_key,
        fp::write_hdf_with_options,
        fp::write_html,
        fp::write_html_string,
        fp::write_html_string_with_options,
        fp::write_html_with_options,
        fp::write_ipc_stream_bytes,
        fp::write_json,
        fp::write_json_string,
        fp::write_jsonl,
        fp::write_jsonl_string,
        fp::write_latex,
        fp::write_latex_string,
        fp::write_latex_string_with_options,
        fp::write_latex_with_options,
        fp::write_markdown,
        fp::write_markdown_string,
        fp::write_markdown_string_with_options,
        fp::write_markdown_with_options,
        fp::write_orc,
        fp::write_orc_bytes,
        fp::write_parquet,
        ...
        fp::write_pickle_with_options,
        fp::write_stata,
        fp::write_stata_bytes,
        fp::write_stata_bytes_with_options,
        fp::write_stata_with_options,
        fp::write_xml,
        fp::write_xml_string,
        fp::write_xml_string_with_options,
...
fn facade_reexports_cover_every_fp_io_read_write_fn() {
    ...
    assert!(
        !found.is_empty(),
        "parser found nothing — the audit itself is broken"
    );
